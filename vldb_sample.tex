...
From the system perspective, the most
similar system is designed by Sparks et al.~\cite{SparksTHFJK15} that integrates automatic model
selection into Spark ML. 

, though the authors only considered the single-tenant model selection problem.
...
Modeling the model selection problem 
as a multi-armed bandit problem is not new. 
